...
const products: Product[] = [
  ...
  },
  {
    ...
    color: 'Dark Gray',
    model: 'Galaxy Tab A7 Lite Wi-Fi',
    capacity: '64',
    price: 299,
    img: './assets/images/products/samsung-galaxy-tab-a7-lite-dark-gray.jpeg',
    inStockCount: 13,
    popular: false,
  },
  {
    ...
    category: 'notebook',
    brand: 'Lenovo',
    releaseDate: 'June 10, 2020',
    color: 'Black',
    model: 'IdeaPad Gaming 3',
    capacity: '512',
    price: 899,
    img: './assets/images/products/lenovo-ideapad-gaming-3-black.jpeg',
    inStockCount: 31,
    popular: true,
  },
  {
    ...
    color: 'Dark Blue',
    model: 'MagicBook View 14',
    capacity: '512',
    price: 1599,
    img: './assets/images/products/honor-magic-book-view-14-dark-blue.jpeg',
    inStockCount: 18,
    popular: true,
  },
];
